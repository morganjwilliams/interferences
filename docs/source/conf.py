...
# -*- coding: utf-8 -*-
#
# interferences documentation build configuration file, created by
# sphinx-quickstart
#
...
version = re.findall(r"^[\d]*.[\d]*.[\d]*", interferences.__version__)[0]
release = version
...
html_context = {
    ...
    "github_repo": "interferences",  # Repo name
...
htmlhelp_basename = "interferencesdoc"
...
man_pages = [(master_doc, "interferences", "interferences Documentation", [author], 1)]
...
github_doc_root = "https://github.com/morganjwilliams/interferences/tree/develop/docs/"
...
.. raw:: html
  ...
  <a href="https://github.com/morganjwilliams/interferences"
     class="github-corner"
